...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__highlightclips__ = __webpack_require__(849);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_services_clips_service__ = __webpack_require__(204);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__app_models_highlightclip_model__ = __webpack_require__(513);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HighlightClipsPage = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.getHighlightLinks()];
                    case 3:
                        _a.sent();
    ...
    HighlightClipsPage.prototype.generate = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.highlightsService.generate(this.highlightUuid);
                return [2 /*return*/];
            });
        });
    };
     ...
     *
     */
    HighlightClipsPage.prototype.getHighlightLinks = function () {
        return __awaiter(this, void 0, void 0, function () {
            var highlightLinks, that;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.highlightsService.getHighlightLinks(this.highlightUuid)];
                    case 1:
                        highlightLinks = _a.sent();
                        that = this;
                        that.ngZone.run(function () {
                            that.highlightLinks = highlightLinks;
                        });
                        return [2 /*return*/];
                }
            });
