...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__trending_channel__ = __webpack_require__(619);
...
var TrendingChannelPage = /** @class */ (function () {
    function TrendingChannelPage(navCtrl, clipsService, _sanitizer, _ngZone, navParams) {
    ...
    TrendingChannelPage.prototype.ngOnInit = function () {
        this.getTrendingByChannel(this.channel);
    };
    TrendingChannelPage.prototype.getTrendingByChannel = function (channel) {
        var that = this;
        this.clipsService.getTrendingByChannel(channel, that.cursor).then(function (trendingClips) {
    ...
    TrendingChannelPage.prototype.goToPage = function (page) {
        var navOptions = {};
