...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__trending_game__ = __webpack_require__(624);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_array_equal__ = __webpack_require__(347);
...
var TrendingGamePage = /** @class */ (function () {
    function TrendingGamePage(navCtrl, clipsService, _sanitizer, _ngZone, navParams, localStorageService, popoverCtrl, loaderService, toastService) {
    ...
    TrendingGamePage.prototype.ngOnInit = function () {
        ...
        this.getTrendingByGame(this.game, false);
    };
    TrendingGamePage.prototype.getTrendingByGame = function (game, refresh) {
        var that = this;
        var promise;
        promise = this.clipsService.getTrendingByGame(game, that.gameCursor, this.period, this.languages.join(',')).then(function (trendingClips) {
    ...
    TrendingGamePage.prototype.refreshData = function (data) {
        ...
        if (!(oldPeriod === data.period && __WEBPACK_IMPORTED_MODULE_5_array_equal__(oldLanguages, data.languages))) {
            ...
            that.getTrendingByGame(that.game, true);
        }
    };
